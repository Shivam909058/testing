...
class YouTubeToBlog:
    ...
    def generate_blog_post(self):
        ...
        try:
            prompt = f"""
            You are a professional blog writer. Convert the following transcript from a YouTube video into 
            a high-quality, authentic blog post with excellent SEO optimization.
            ...
            3. Organizes content into logical sections with H2 and H3 headings
            4. Incorporates relevant keywords naturally
            5. Includes a conclusion with call-to-action
            6. Is 100% unique and authentic in tone
            7. Has a total word count of 1200-1500 words
            8. Uses markdown formatting
            
            TRANSCRIPT:
            {self.transcript}
            
            Format the blog with proper markdown, including:
            - # for the main title
            ...
            Create a blog that sounds natural and provides value to readers.
            """
            
            response = openai.chat.completions.create(
                model="gpt-4o",
                messages=[
                    {"role": "system", "content": "You are a professional blog writer skilled in SEO optimization."},
            ...
            self._save_to_cache("blog", self.blog_content)
            
            print(f"Blog post generated and saved to: {blog_path}")
            return blog_path
